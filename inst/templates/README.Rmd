...
Install the pre-release version of **EDIT-PACKAGE-NAME**:

```
# install.packages("devtools")
devtools::install_github("forestgeo/EDIT-PACKAGE-NAME@pre-release")
```

Or install the development version of **EDIT-PACKAGE-NAME**:
